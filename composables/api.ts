...
function getValues(object: string[]) {
	return (
		"'" + object.slice(0, -1).join("', '") + "' or '" + object.slice(-1) + "'"
	);
}
...
const recipeRoutes: Route[] = [
	{
		...
		params: [
			...
			},
			{
				...
				type: "int",
				description:
					"What 'page' of results you want to get back, each page is the size given by `size`",
				default: 0,
			},
			{
				name: "query",
			...
			recipes: [
				{
					...
					thumbnail: "string",
					deleteKey2:
						"==COMMENT==// Time required to make this recipe, in minutes.",
					time: "int",
					deleteKey3:
						"==COMMENT==// The type of recipe, e.g. Breakfast, Diner, ....",
					type: "string",
					difficulty: "string",
	...
	},
	{
		...
		route: "/api/recipes",
		explanation:
			"Adds a new recipe, in order to use this request you need to be logged in first.",
		bodyType: {
			deleteKey7:
			...
			location: "string",
			deleteKey4:
				"==COMMENT==// The length of your description should be at least 50 characters.",
			description: "string",
			deleteKey1:
			...
			ingredients: [
				{
					...
					amount: "int",
					deleteKey2:
						"==COMMENT==// Defines the order your ingredients should be displayed in.",
					index: "int",
					deleteKey3:
				...
				body: JSON.stringify(
					{
						...
						recipe:
							"This is how you make this amazing recipe, that you can definitely actually make and is not an example because that would be stupid to actually add it.",
	...
	},
	{
		...
		title: "Update recipe",
		explanation:
			"Updates the given recipe, in order to use this request you need to be logged in first.",
		route: "/api/recipes/[ID]",
		returnType: "boolean",
		bodyType: {
			deleteKey7:
	...
	},
	{
		...
		title: "Delete recipe",
		explanation:
			"Deletes the given recipe, in order to use this request you need to be logged in first.",
		route: "/api/recipes/[ID]",
		returnType: "boolean",
		authRequired: true,
		example: {
...
const ratingRoutes: ApiRoute[] = [
	{
		...
		routes: [
				...
				params: [
					{
						...
						type: "string",
						description:
							"The user ID for the user that you want the rating for",
					},
				],
				example: {
					url: {
			...
			},
			{
				...
				authRequired: true,
				bodyExplanation:
					"Your new rating, this should be a number between 0 and 5, inclusive.",
				bodyType: "int",
				example: {
...
const commentRoutes: Route[] = [
	{
		method: "POST",
		title: "New comment",
		explanation: "Send a new comment to the database",
		route: "/api/comments",
		bodyType: {
			deleteKey1:
				"==COMMENT==// Note that values like `ID`, `user` and `createdAt` should NOT be speciffied in the body, these will be added automatically.",
			// Note that values like `ID`, `user` and `createdAt` should NOT be speciffied in the body, these will be added automatically.
			...
			deleteKey5:
				"==COMMENT==// Give the id of the recipe where the comment belongs to",
			recipe: "string",
		},
		returnType: "boolean",
		authRequired: true,
				...
				body: JSON.stringify(
					{
						...
						recipe:
							"you need to put here a recipe ID --- maybe recplace this to recipe/[id]/comment.post.ts",
					},
					null,
					4,
				),
	...
	},
	{
		...
		explanation: "Delete the current comment, it likes, and it replies (with again their likes)",
		route: "/api/comments/[ID]",
		returnType: "void",
		example: {
			url: "/api/comments/[ID]",
