...
import { apiRoutes } from "~/composables/api";
...
<template>
    <div class="apiDocs">
        ...
        This is the API documentation for our site.
        <br />
        Some routes do require authentication, if you are using them through this page, and you are logged in this will not
