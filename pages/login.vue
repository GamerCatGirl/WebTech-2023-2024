	...
	<div class="card">
		<div class="flex flex-column md:flex-row">
			<div class="w-full md:w-5 flex flex-column align-items-center justify-content-center gap-3 py-5">
				...
				<!--Register-->
				<Button label="Register" icon="pi pi-user-plus" severity="succes" class="w-10rem"
					@click="navigateTo('register')"></Button>
			</div>
			...
			<div>
				...
				<div class="flex-column flex align-items-center justify-content-center gap-2">
					<Button label="Github" icon="pi pi-github" severity="success" class="w-10rem"
						@click="signIn('github', { callbackUrl })"></Button>

					<Button label="Google" icon="pi pi-google" severity="success" class="w-10rem"></Button>

					<Button label="Facebook" icon="pi pi-facebook" severity="success"
